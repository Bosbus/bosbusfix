    ...
    <div class="pre-footer">
      <div class="container">
        ...
        <div class="row mix-block margin-bottom-40">
          ...
          <!-- TESTIMONIALS -->
          <div class="col-lg-12 testimonials-v1">
        ...
        <!-- END TABS AND TESTIMONIALS -->
            <!-- <div class="photo-stream">
              ...
              <ul class="list-unstyled">
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/people/img5-small.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img1.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/people/img4-large.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img6.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img3.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/people/img2-large.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img2.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img5.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/people/img5-small.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img1.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/people/img4-large.jpg"></a></li>
                <li><a href="javascript:;"><img alt="" src="<?php echo base_url() ; ?>assets/pages/img/works/img6.jpg"></a></li>
